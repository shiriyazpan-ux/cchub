...
const tips = [
  "אל תכתבו סיסמאות בשם המשימה או בהערות פתוחות.",
  "שמרו כל גישה תחת הנכס הדיגיטלי המתאים.",
  "כאשר גישה משתנה, עדכנו אותה מיד כדי למנוע בלבול.",
];
      ...
      <section className="cchub-container py-16">
        ...
        <div className="mt-10 rounded-[30px] bg-[#061A44] p-8 text-center text-white">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            <a className="cchub-button-primary" href="/tutorials/digital-assets">למדריך נכסים דיגיטליים</a>
