...
export const metadata: Metadata = {
  title: "איך מתאימים שמות ומונחים במערכת CCHUB | מדריך CCHUB",
  description: "מדריך להתאמת שמות, מילים ומונחים ב-CCHUB לשפה הפנימית של העסק והצוות.",
  alternates: { canonical: "/tutorials/custom-terms" },
};

const steps = [
  "מגדירים אילו מילים במערכת פחות מתאימות לשפה של העסק.",
  "מחליטים על מונחים פנימיים קבועים שהצוות מכיר.",
  "מעדכנים את השמות והמילים במקומות הנתמכים במערכת.",
  "בודקים שהשינוי ברור גם למשתמשים חדשים.",
  "שומרים על עקביות ולא משנים מונחים לעיתים קרובות מדי.",
];

const tips = [
  "מונחים טובים מקצרים הדרכה לצוות.",
  "אל תבחרו שמות פנימיים שרק אדם אחד מבין.",
  "כדאי לשמור מילים פשוטות וברורות.",
];
    ...
    <main dir="rtl" className="min-h-screen bg-[#F6FAFF] text-[#071B4D]">
      ...
      <section className="cchub-container py-16">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <h1 className="cchub-title-xl mt-5">איך מתאימים שמות ומונחים במערכת CCHUB</h1>
          <p className="cchub-text mt-5">עסקים שונים משתמשים במילים שונות. התאמת מונחים מאפשרת למערכת לדבר בשפה של העסק.</p>
        </div>
        ...
        <div className="mt-10 rounded-[30px] bg-[#061A44] p-8 text-center text-white">
          ...
          <div className="mt-6 flex flex-wrap justify-center gap-4">
            <a className="cchub-button-primary" href="/tutorials/make-zapier">למדריך Make / Zapier</a>
